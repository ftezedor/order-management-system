...
class MethodArgumentNotValidExceptionTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders
                ...
                .setValidator(validator) // Pass validator for bean validation
                .build();
    }
    ...
    @RestController
    private static class TestValidationController {

        @PostMapping("/test/validate")
        public void validateBody(@Valid @RequestBody TestRequest request) {
            // No implementation needed; validation exception is thrown before entering the method
        }
    }
